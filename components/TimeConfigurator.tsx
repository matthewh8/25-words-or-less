    ...
    <div className="rounded-lg border border-white/10 bg-[#141826] p-3 md:p-5">
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          className="flex-1 rounded-md border border-white/10 bg-[#0a0d14] px-3 py-2 text-center text-sm font-bold text-white outline-none transition-colors placeholder-white/20 focus:border-[#ffd23f]/60 [appearance:textfield] [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none"
        />
