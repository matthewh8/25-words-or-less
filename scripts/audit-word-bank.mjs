...
const EXPECTED_OPEN_WORDNET_MONEY = 160
const MAX_MONEY_COMPONENT_REPEAT = 20
...
const BLOCKED_WORDS = new Set([
  ...
  'ANAL', 'AMPHETAMINE', 'BITCH', 'COCK', 'CUNT', 'DICK',
  'DICKHEAD', 'DRUG', 'DRUGGED', 'DRUGGING', 'DRUGS', 'FAG',
  'FAGGOT', 'FASCISM', 'FASCIST', 'FASCISTS',
  'FUCK', 'FUCKED', 'FUCKER', 'FUCKING', 'GENOCIDE', 'GOOK', 'GYP',
  'GYPPED', 'GYPPING', 'GYPSY',
  'HOLOCAUST', 'HOMICIDE', 'INCEST', 'INTERCOURSE', 'MAIM',
  'MAIMED', 'MAIMING', 'MAIMS', 'MASSACRE',
  'MOLEST', 'MOLESTED', 'MOLESTING', 'MOLESTS', 'MURDER',
  'MURDERED', 'MURDERER', 'MURDERERS', 'MURDERING', 'MURDERS',
  'NAZI', 'NAZIS', 'NIGGA', 'NIGGER', 'PISS', 'PISSED',
  'PISSING', 'PORN', 'PORNO', 'PORNOGRAPHY', 'RAPE', 'RAPED', 'RAPIST', 'RAPISTS', 'RAPING',
